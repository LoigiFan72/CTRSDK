...
void RequestDma(const void* pDst, const void* pSrc, size_t size, bool flushCache, bool check);
...
void WriteHWRegsWithMask(uint regOffset, const void* pSrc, const void* pMask, size_t size);
