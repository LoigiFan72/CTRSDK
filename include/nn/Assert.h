...
#define NN_FUNCTION             __PRETTY_FUNCTION__
    ...
    #define NN_PANIC_WITH_RESULT_(result, ...)  ((void)nnResultTPanicHandler(static_cast< ::nn::Result>(result), NN_FILE_NAME, __LINE__, __VA_ARGS__), NN_PANIC_(__VA_ARGS__))
    ...
    #define NN_TPANIC_WITH_RESULT_(result, ...)  ((void)nnResultTPanicHandler(static_cast< ::nn::Result>(result), NN_FILE_NAME, __LINE__, __VA_ARGS__), NN_TPANIC_(__VA_ARGS__))
    #define NN_TPANIC_IF_NULL_(exp)              NN_TPANIC_IF_FALSE_(exp)
    #define NN_TPANIC_IF_FAILED_(result)                    \
        do {                                                \
            ::nn::Result nn_result_try_result = (result);   \
